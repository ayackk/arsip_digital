...
class ArsipStats extends StatsOverviewWidget
{
    ...
    {
        return [
            Stat::make('Total Arsip', ArsipDokumen::count())
                ->description('Semua dokumen tersimpan')
                ->descriptionIcon('heroicon-m-document')
                ->color('primary'),

            Stat::make('Tempat Penyimpanan', TempatPenyimpanan::count())
                ->description('Lokasi fisik')
                ->descriptionIcon('heroicon-m-map-pin')
                ->color('success'),

            Stat::make('Unit Pengolah', UnitPengolah::count())
                ->description('Unit kerja')
                ->descriptionIcon('heroicon-m-building-office')
                ->color('warning'),

            Stat::make('Jenis Arsip', JenisArsip::count())
